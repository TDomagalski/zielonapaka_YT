...
export default function NotFound() {
  return (
    <section className="max-w-screen-2xl mx-auto px-4 sm:px-8 my-16 lg:my-32 text-center">
      ...
      <Link
        className="bg-green-700 inline-block shadow-lg shadow-green-700/50 text-white font-medium text-lg py-3 px-12 rounded-lg hover:bg-green-800 trasition-all duration-300"
        href="/"
      >
        Strona główna
      </Link>
